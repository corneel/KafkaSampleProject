...
template<> KAFKA_API UScriptStruct* StaticStruct<FKafkaDriverErrorStructure>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UKafkaBPLibrary_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UKafkaBPLibrary_KafkaConsumeAll, "KafkaConsumeAll" }, // 2977928365
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_Kafka_Source_Kafka_Public_KafkaBPLibrary_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Kafka_Source_Kafka_Public_KafkaBPLibrary_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Kafka_Source_Kafka_Public_KafkaBPLibrary_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Kafka_Source_Kafka_Public_KafkaBPLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UKafkaBPLibrary, UKafkaBPLibrary::StaticClass, TEXT("UKafkaBPLibrary"), &Z_Registration_Info_UClass_UKafkaBPLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UKafkaBPLibrary), 766524791U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Kafka_Source_Kafka_Public_KafkaBPLibrary_h_2971038551(TEXT("/Script/Kafka"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_Kafka_Source_Kafka_Public_KafkaBPLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_Kafka_Source_Kafka_Public_KafkaBPLibrary_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_Kafka_Source_Kafka_Public_KafkaBPLibrary_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_Kafka_Source_Kafka_Public_KafkaBPLibrary_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_Kafka_Source_Kafka_Public_KafkaBPLibrary_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_Kafka_Source_Kafka_Public_KafkaBPLibrary_h_Statics::EnumInfo));
