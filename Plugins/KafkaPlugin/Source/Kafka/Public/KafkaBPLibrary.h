...
class UKafkaBPLibrary : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Kafka Consume All", Keywords = "Kafka Consumer All"), Category = "KafkaPlugin")
		bool KafkaConsumeAll(FName Topic, TMap<FString, FString> ConfigurationSettings, TArray<FString>& MessageArray, FKafkaDriverErrorStructure& KafkaErrorStructure, int Timeout = 500, int NumberOfRetries = 20);
