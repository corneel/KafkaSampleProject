...
bool UKafkaBPLibrary::KafkaConsumeAll(FName Topic, TMap<FString, FString> ConfigurationSettings, TArray<FString>& MessageArray, FKafkaDriverErrorStructure& KafkaErrorStructure)
{
